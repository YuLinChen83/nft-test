...
const colors = (darkMode: boolean): Colors => ({
  ...
  bg2: darkMode ? "#2C2F36" : "#e0dbd8",
  bg3: darkMode ? "#40444F" : "#fffdf8",
  bg4: darkMode ? "#565A69" : "#fdf7e9",
  ...
  //primary colors
  primary1: darkMode ? "#2172E5" : "#87776e",
...
const theme = (darkMode: boolean): DefaultTheme => ({
  ...colors(darkMode),
